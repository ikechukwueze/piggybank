...
urlpatterns = [
    ...
    path("password-reset/<encrypted_user_id>/<password_reset_token>/", views.PasswordResetView.as_view(), name="password-reset"),
    path("complete-password-reset/<encrypted_user_id>/<password_reset_token>/<encrypted_email/", views.CompletePasswordResetView.as_view(), name="confirm-password-reset"),
